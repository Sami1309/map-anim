...
const ANIMATION_CONTEXT_EXAMPLES = [
    {
 ...
 */
export function getAnimationStyleContext(prompt) {
    const lowerPrompt = prompt.toLowerCase();
    const matchedStyles = [];
    for (const style of ANIMATION_CONTEXT_EXAMPLES) {
        const hasKeyword = style.keywords.some(keyword => lowerPrompt.includes(keyword.toLowerCase()));
        if (hasKeyword) {
 ...
 */
export function generateStyleContextMessages(prompt) {
