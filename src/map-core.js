// Shared map setup functions used by both renderer-page.html and web app
...
export async function setupBorderLayers(map, program, borderData) {
  ...
  setupBorderLinesLayer(map, program);
  setupBorderDrawnLayer(map, program);
  setupBorderTraceLayer(map, program);

  return highlight;
}

// Setup the main border line layer
function setupBorderLinesLayer(map, program) {
...
function setupBorderDrawnLayer(map, program) {
...
function setupBorderTraceLayer(map, program) {
